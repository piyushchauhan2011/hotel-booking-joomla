...
/**
 * Contact page: core address + form, plus a Role facts strip from job-title / department.
 */
...
foreach ($this->item->jcfields ?? [] as $hbField) {
    if (!\in_array($hbField->name, $roleNames, true)) {
        continue;
    }
...
<div class="com-contact contact hb-contact">
    ...
    <?php if ($this->params->get('show_info', 1)) : ?>
        <div class="com-contact__container">
            ...
            <?php if ($this->item->image && $tparams->get('show_image')) : ?>
                <div class="com-contact__thumbnail thumbnail hb-contact-photo">
            ...
            <?php if ($roleFacts) : ?>
                <aside class="hb-article-facts hb-contact-role" aria-label="<?php echo Text::_('COM_HOTELBOOKING_CONTACT_ROLE_TITLE'); ?>">
                    <p class="hb-article-facts-title"><?php echo Text::_('COM_HOTELBOOKING_CONTACT_ROLE_TITLE'); ?></p>
                    <dl>
                        <?php foreach ($roleFacts as $hbField) : ?>
