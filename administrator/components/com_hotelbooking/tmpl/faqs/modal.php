...
$function  = Factory::getApplication()->getInput()->getCmd('function', 'jSelectFaq');
$multilang = Multilanguage::isEnabled();
?>
<div class="container-popup">
	<form action="<?php echo Route::_('index.php?option=com_hotelbooking&view=faqs&layout=modal&tmpl=component&function=' . $function . '&' . Session::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm">
		<div class="row">
			<div class="col-md-6">
			...
			<table class="table table-sm">
				<thead>
					<tr>
						...
						<th><?php echo Text::_('COM_HOTELBOOKING_FIELD_QUESTION_LABEL'); ?></th>
						<?php if ($multilang) : ?>
					...
					<tr>
						...
						<th scope="row">
							<a class="select-link" href="javascript:void(0)"
								...
								data-title="<?php echo htmlspecialchars($item->question); ?>"
								>
