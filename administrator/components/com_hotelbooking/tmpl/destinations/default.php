	...
	<table class="table">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr>
				...
				<td>
					<a href="<?php echo Route::_('index.php?option=com_hotelbooking&task=destination.edit&id=' . (int) $item->id); ?>">
		...
		<?php if (empty($this->items)) : ?>
			<tr>
				<td colspan="<?php echo $multilang ? 5 : 4; ?>"><?php echo Text::_('JGLOBAL_NO_MATCHING_RESULTS'); ?></td>
			</tr>
		<?php endif; ?>
		</tbody>
	</table>
