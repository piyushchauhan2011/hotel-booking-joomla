...
/** @var \Learn\Component\Hotelbooking\Administrator\View\Destinations\HtmlView $this */
...
$function  = Factory::getApplication()->getInput()->getCmd('function', 'jSelectDestination');
$multilang = Multilanguage::isEnabled();
?>
<div class="container-popup">
	<form action="<?php echo Route::_('index.php?option=com_hotelbooking&view=destinations&layout=modal&tmpl=component&function=' . $function . '&' . Session::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm">
		<div class="row">
			<div class="col-md-6">
